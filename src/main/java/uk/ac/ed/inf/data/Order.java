...
public final class Order {
    ...
    /**
     * Copy constructor to create a new Order instance from an existing one
     *
    ...
    public Order(Order other) {
        ...
        this.orderValidationCode = other.orderValidationCode;
        this.priceTotalInPence = other.priceTotalInPence;
        this.pizzasInOrder = Arrays.copyOf(other.pizzasInOrder, other.pizzasInOrder.length);
